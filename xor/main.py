...
def main(args):
    ...
    train_config = DatasetConfig(name="train", d=args.d, n=args.m * args.steps,
        m=args.m, seed=args.train_seed, lmbda=args.lmbda, spurious=True)
    test_config = DatasetConfig(name="test", d=args.d, n=args.n_test,
        m=args.m, seed=args.test_seed, lmbda=args.lmbda, spurious=True)
    model_config = ModelConfig(
        d=args.d, p=args.p, theta=args.theta, spurious=True)
    ...
    experiment = Experiment(
        train_dataset, [test_dataset], model, experiment_config)
