...
def _add_input_args(parser: Parser) -> Parser:
    ...
    parser.add("--C", default=2, type=int,
               help="Constant C for initialization as in Glasgow (2024).")
    parser.add("--d", default=100, type=int,
               help="The dimension of the data.")
    parser.add("--hybrid", default=False, type=lambda x: bool(strtobool(x)),
               help=("Whether to use the hybrid gradient, i.e., the Lp gradient"
                     " for w_sp and the L0 gradient for other parameters."))
    parser.add("--lmbda", default=0.2, type=float,
               help=("The lambda parameter corresponding to the strength of the"
    ...
    parser.add("--loss", default="lp", choices=["l0", "lp"],
               help=("The training loss to use."
                     " 'l0' is the first-order logistic loss (Glasgow 2024)."
                     " 'lp' is the standard logistic loss."))
    parser.add("--n_test", default=100000, type=int,
               help="The number of data for testing.")
    parser.add("--steps", default=100, type=int,
               help="The number of train steps.")
    parser.add("--train_seed", default=0, type=int,
               help="The RNG seed for the train dataset.")
    parser.add("--test_seed", default=1, type=int,
               help="The RNG seed for the test dataset(s).")
    return parser
